...
<body>
    <div class="mx-4">
        ...
        <div class="grid grid-cols-1 space-y-4 mb-[300px]">
            ...
            <div class="w-full flex">
                <div class="flex w-[150px] aspect-square bg-[#D9BD8E] rounded-[20px] shadow-2xl overflow-hidden">
                ...
                <div class="flex flex-col justify-between w-full">
                    <div class="py-1 px-2">
                        <div class="font-semibold text-lg text-[#4D301B]">Cap Cay</div>
                        <div class="font-bold text-xl text-[#865B33]">Rp.15.000</div>
                    </div>
                    <div class="flex items-center justify-end space-x-4">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_16_369)">
                                <path d="M7.61161 2.01562L6.76339 3.125H13.2366L12.3884 2.01562C12.3214 1.92969 12.2098 1.875 12.0893 1.875H7.90625C7.78571 1.875 7.67411 1.92578 7.60714 2.01562H7.61161ZM14.1741 0.976562L15.8125 3.125H16.4286H18.5714H18.9286C19.5223 3.125 20 3.54297 20 4.0625C20 4.58203 19.5223 5 18.9286 5H18.5714V16.875C18.5714 18.6016 16.9732 20 15 20H5C3.02679 20 1.42857 18.6016 1.42857 16.875V5H1.07143C0.477679 5 0 4.58203 0 4.0625C0 3.54297 0.477679 3.125 1.07143 3.125H1.42857H3.57143H4.1875L5.82589 0.972656C6.29018 0.367188 7.07143 0 7.90625 0H12.0893C12.9241 0 13.7054 0.367188 14.1696 0.972656L14.1741 0.976562ZM3.57143 5V16.875C3.57143 17.5664 4.20982 18.125 5 18.125H15C15.7902 18.125 16.4286 17.5664 16.4286 16.875V5H3.57143ZM7.14286 7.5V15.625C7.14286 15.9688 6.82143 16.25 6.42857 16.25C6.03571 16.25 5.71429 15.9688 5.71429 15.625V7.5C5.71429 7.15625 6.03571 6.875 6.42857 6.875C6.82143 6.875 7.14286 7.15625 7.14286 7.5ZM10.7143 7.5V15.625C10.7143 15.9688 10.3929 16.25 10 16.25C9.60714 16.25 9.28571 15.9688 9.28571 15.625V7.5C9.28571 7.15625 9.60714 6.875 10 6.875C10.3929 6.875 10.7143 7.15625 10.7143 7.5ZM14.2857 7.5V15.625C14.2857 15.9688 13.9643 16.25 13.5714 16.25C13.1786 16.25 12.8571 15.9688 12.8571 15.625V7.5C12.8571 7.15625 13.1786 6.875 13.5714 6.875C13.9643 6.875 14.2857 7.15625 14.2857 7.5Z" fill="#4D301B"/>
                            </g>
                            <defs>
                        ...
                        <div class="flex space-x-4 py-1 px-2 rounded-lg bg-[#EBD2A2]">
                            <div class="font-semibold text-[#4D301B]">-</div>
                            <div class="font-semibold text-[#4D301B]">1</div>
                            <div class="font-semibold text-[#4D301B]">+</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-full flex">
                ...
                <div class="flex flex-col justify-between w-full">
                    <div class="py-1 px-2">
                        <div class="font-semibold text-lg text-[#4D301B]">Cumi Goreng</div>
                        <div class="font-bold text-xl text-[#865B33]">Rp.20.000</div>
                    </div>
                    <div class="flex items-center justify-end space-x-4">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_16_369)">
            ...
            <div class="w-full flex">
                ...
                <div class="flex flex-col justify-between w-full">
                    <div class="py-1 px-2">
                        <div class="font-semibold text-lg text-[#4D301B]">Gurame</div>
            ...
            <div class="w-full flex">
                ...
                <div class="flex flex-col justify-between w-full">
                    <div class="py-1 px-2">
                        <div class="font-semibold text-lg text-[#4D301B]">Ayam Goreng</div>
                        <div class="font-bold text-xl text-[#865B33]">Rp.15.000</div>
                    </div>
                    <div class="flex items-center justify-end space-x-4">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <!-- Confirm Checkout -->
    <div class="fixed space-y-4 w-full bottom-20 px-4 bg-white">
        <div>
            <div class="w-full h-1 bg-[#865B33] rounded"></div>
            <div class="flex justify-between">
                <div class="font-semibold text-lg text-[#4D301B] pl-[24px]">Seat :</div>
                <div class="font-semibold text-lg text-[#4D301B]">2 Person</div>
            </div>
            <div class="flex justify-between">
                <div class="font-bold text-2xl text-[#4D301B]">Total :</div>
                <div class="font-bold text-2xl text-[#4D301B]">Rp. 75.000</div>
            </div>
        </div>
        <div class="flex w-full items-center justify-center py-4 rounded-[15px] font-semibold text-white text-xl shadow-xl bg-[#865B33]">
            Confirm Order
        </div>
    </div>
