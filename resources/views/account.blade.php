...
<body>
    <div class="mx-4">
        ...
        <div class="flex justify-between items-center pt-4 pb-8">
            <div class="font-bold text-3xl">Account</div>
                ...
                <div class="w-full flex flex-col items-center">
                    <svg width="110" height="110" viewBox="0 0 110 110" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_108_464)">
                            <rect width="110" height="110" rx="55" fill="#865B33"/>
                            <path d="M85.7227 82.543C80.9746 74.293 72.0586 68.75 61.875 68.75H48.125C37.9414 68.75 29.0254 74.293 24.2773 82.543C31.8398 90.9648 42.7969 96.25 55 96.25C67.2031 96.25 78.1602 90.9434 85.7227 82.543ZM0 55C0 40.4131 5.79463 26.4236 16.1091 16.1091C26.4236 5.79463 40.4131 0 55 0C69.5869 0 83.5764 5.79463 93.8909 16.1091C104.205 26.4236 110 40.4131 110 55C110 69.5869 104.205 83.5764 93.8909 93.8909C83.5764 104.205 69.5869 110 55 110C40.4131 110 26.4236 104.205 16.1091 93.8909C5.79463 83.5764 0 69.5869 0 55ZM55 58.4375C59.1026 58.4375 63.0371 56.8078 65.9381 53.9068C68.839 51.0059 70.4688 47.0713 70.4688 42.9688C70.4688 38.8662 68.839 34.9316 65.9381 32.0307C63.0371 29.1297 59.1026 27.5 55 27.5C50.8974 27.5 46.9629 29.1297 44.0619 32.0307C41.161 34.9316 39.5312 38.8662 39.5312 42.9688C39.5312 47.0713 41.161 51.0059 44.0619 53.9068C46.9629 56.8078 50.8974 58.4375 55 58.4375Z" fill="#EBD2A2"/>
                        </g>
                        <defs>
                    ...
                    <!-- Account Name -->
                    <div class="font-bold text-xl text-[#865B33]">I Putu Bramanda</div>                      
                </div>
                <div class="w-full flex flex-col items-center space-y-4">
                    <!-- Input -->
                    <div class="w-[80%] flex items-center bg-[#EBD2A2] px-4 py-2 space-x-4 rounded-[20px] drop-shadow-md">
                        <div class="w-8 p-1">
                    ...
                    <div class="text-[#865B33] text-sm">Change Password</div>
                </div>
                <div class="flex w-full justify-center">
                    <div class="font-medium text-white text-base px-[75px] py-[12px] bg-[#865B33] rounded-[20px] drop-shadow-lg">
                        Register
                    </div>
                </div>
            </div>
