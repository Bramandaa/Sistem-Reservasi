...
<body>
    <div class="mx-4">
        ...
        <!-- Content Wrapper -->
        <div class="grid grid-cols-1 space-y-4 mb-20">
            <!-- Item -->
            <div class="flex w-full">
                <div class="flex flex-col justify-center space-y-2 w-full h-[120px] bg-[#D9BD8E] rounded-[20px] shadow-2xl overflow-hidden">
                    <div class="flex justify-center font-semibold text-[#4D301B]">Book for:</div>
                    <div class="flex justify-center space-x-2">
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_16_772)">
                                <path d="M15 15C17.2733 15 19.4535 14.2098 21.0609 12.8033C22.6684 11.3968 23.5714 9.48912 23.5714 7.5C23.5714 5.51088 22.6684 3.60322 21.0609 2.1967C19.4535 0.790176 17.2733 0 15 0C12.7267 0 10.5465 0.790176 8.93908 2.1967C7.33163 3.60322 6.42857 5.51088 6.42857 7.5C6.42857 9.48912 7.33163 11.3968 8.93908 12.8033C10.5465 14.2098 12.7267 15 15 15ZM11.9397 17.8125C5.34375 17.8125 0 22.4883 0 28.2598C0 29.2207 0.890625 30 1.98884 30H28.0112C29.1094 30 30 29.2207 30 28.2598C30 22.4883 24.6562 17.8125 18.0603 17.8125H11.9397Z" fill="#865B33"/>
                            </g>
                            <defs>
                    ...
                    <div class="flex justify-center font-semibold text-xl leading-none text-[#865B33]">Person</div>
                </div>
            </div>
            ...
            <div class="flex w-full">
                <div class="flex flex-col justify-center space-y-2 w-full h-[120px] bg-[#D9BD8E] rounded-[20px] shadow-2xl overflow-hidden">
                    <div class="flex justify-center font-semibold text-[#4D301B]">Book for:</div>
                    <div class="flex justify-center font-bold text-2xl leading-none text-[#865B33]">Spesific</div>
                </div>
            </div>
    ...
    <div class="fixed flex justify-between items-center w-full bottom-0 py-4 px-8 bg-[#EBD2A2] rounded-t-[20px]">
        ...
        <!-- Button -->
        <a class="space-y-2" href="/account">
            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
