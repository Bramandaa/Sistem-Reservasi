...
<body>
    <div class="w-full h-screen bg-[#D9BD8E]">
        ...
        <div class="flex flex-col w-full items-center space-y-4">
            <!-- Input -->
            <div class="w-[75%] flex items-center bg-[#FFFDF5]/[0.72] px-4 py-3 space-x-4 rounded-[20px]">
                <div class="w-8 p-1">
        ...
        <div class="flex w-full justify-center">
            <div class="font-medium text-white text-base px-20 py-[12px] bg-[#865B33] rounded-[20px]">
                Register
            </div>
        </div>
    </div>
